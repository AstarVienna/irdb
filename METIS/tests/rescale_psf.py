...
new_hdul.append(rescale_image(old_hdul[2], 5.47))
new_hdul.append(rescale_image(old_hdul[3], 6.79))
new_hdul.append(rescale_image(old_hdul[4], 6.79))
new_hdul.append(rescale_image(old_hdul[5], 6.79))
