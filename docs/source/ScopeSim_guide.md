...
#### 2. Optional: Create a working directory where you want to run simulations
...
In general, the structure usually is `["<site>", "<telescope>", "<instrument>"]`, although the order of the packages does not matter at all, as long as all relevant ones are present. If you're running simulations for multiple instruments or telescopes, you can simply download them all in one command.
